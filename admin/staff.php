                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>
                                    <button onclick=\"window.location.href='view_staff.php?id=".$row['USER_ID']."'\">View</button>
                                    <button onclick=\"window.location.href='edit_staff.php?id=".$row['USER_ID']."'\">Edit</button>
                                    <button onclick=\"window.location.href='delete_staff.php?id=".$row['USER_ID']."'\">Delete</button>
                                  </td>";
                            echo "</tr>";
                        }
                    } else {
